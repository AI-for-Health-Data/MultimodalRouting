...
class Config:
    ...
    route_entropy_warmup_epochs: float = 5.0     

    route_uniform_lambda: float = 0.01  
    route_uniform_warmup_epochs: float = 5.0      
    ...
    # Priors & misc
    route_prior_floor: float = 0.02           # min clamp for primary acts
    route_prior_ceiling: float = 0.98        # max clamp to avoid saturations
    label_smoothing: float = 0.0             # CE smoothing
