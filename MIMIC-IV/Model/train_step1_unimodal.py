...
def collate_fn(batch):
    ...
    # Normalize as List[List[str]] for bbert
    notes_batch = [
...
behrt, bbert, imgenc = build_encoders(
    EncoderConfig(
        ...
        # (you can override layers/heads/pooling if desired)
...
# Unimodal heads (only L, N, I for step 1)
...
ROOT = os.path.join(CFG.data_root, "MIMIC-IV")  # adjust if needed
